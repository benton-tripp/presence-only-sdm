...
knitr::opts_chunk$set(echo = T, results="hide", 
                      message=F, warning=F, cache=F, root.dir="..")

```

```{r render-github-doc, eval=F, echo=F}

rmarkdown::render(input = "notebooks/get_data.Rmd", 
                  output_format = "html_document", 
                  output_file = "2023-09-10-sdm-benchmark-study-part-1-data-preparation.html",
...
map_df(states, ~obs[[.x]][, .(.N, state=.x), by=.(common.name)]) %>%
  ...
  DT::datatable(
    ...
    DT::formatStyle(1:3, `font-size`="17px")

```


Below is a brief snapshot of the data, filtered to `common.name == "Sandhill Crane"` in North Carolina:
