...
6.  Combine monthly/yearly rasters by variable, applying weights (`arcpy.Raster("aggregated_year_raster") * year_weight + arcpy.Raster("aggregated_month_raster") * month_weight`)
